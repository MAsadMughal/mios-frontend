                        ...
                        {record?.orders?.map((item, ind) => {
                            return (
                                <tr key={ind}>
                                    ...
                                    /></td>
                                    <td className='text-center'><Link to={`/user/order/${item?._id}`}><button className='btn btn-primary'>Order Detail</button></Link></td>
                                </tr>
                            );
                        })}
                    </tbody>
