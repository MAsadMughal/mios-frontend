            ...
            {this.state.orders.map((order) => {
              return (
                <tr className="text-center align-middle" key={order._id}>
                  ...
                  <td className="text-center align-middle"><button className="btn btn-primary btn-sm"
                    >{order.shippingStatus === true ? "Shipped" : "Pending" }</button></td>
                  <td className="text-center align-middle"><button className="btn btn-primary btn-sm" disabled={order.shippingStatus === false ? true : false}>{order.orderStatus === true ? "Delivered" : "Pending"}</button></td>
